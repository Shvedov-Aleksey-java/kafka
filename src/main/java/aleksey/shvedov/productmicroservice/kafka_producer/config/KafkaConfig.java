package aleksey.shvedov.productmicroservice.kafka_producer.config;
...
public class KafkaConfig {
    ...
    Map<String, Object> producerConfig() {
        return Map.of(
                ...
                ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, inFlightRequest,
    ...
    @Bean
    ProducerFactory<String, Object> producerFactory() {return new DefaultKafkaProducerFactory<>(producerConfig());
    }
